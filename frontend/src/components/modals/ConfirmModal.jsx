...
export function ConfirmModal ({ onCancel, onConfirm, title, confirmText = 'Confirmar', children }) {
  return (
    <BackgroundModal closeModal={onCancel}>
      <div className='theme-container grid gap-3 p-0 overflow-hidden max-w-sm'>
        ...
        <footer className='flex gap-2 justify-end mx-4 mb-2'>
          <Button onClick={onCancel} className='bg-transparent text-secondary underline flex-none'>
            Cancelar
          </Button>
